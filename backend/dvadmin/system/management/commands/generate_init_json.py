...
from dvadmin.system.models import Menu, Users, Dept, Role, ApiWhiteList, Dictionary, SystemConfig,RoleMenuPermission,RoleMenuButtonPermission
...
from crud_demo.serializers import CrudDemoModelSerializer
...
class Command(BaseCommand):
    ...
    def serializer_data(self, serializer, query_set: QuerySet):
        ...
        path_file_dir=os.path.join(apps.get_app_config("dvadmin.system".split('.')[-1]).path, 'fixtures')
        with open(os.path.join(path_file_dir, f'init_{query_set.model._meta.model_name}.json'), 'w',encoding='utf-8') as f:
    ...
    def generate_crud_demo(self):
        self.serializer_data(CrudDemoModelSerializer, CrudDemoModel.objects.all())
    ...
    def handle(self, *args, **options):
        ...
        generate_name_dict = {
            ...
            "crud_demo": self.generate_crud_demo,
